'use strict';
angular.module('myApp.calendar', ['ngRoute', 'materialCalendar', 'ngMaterial'])
        ...
        .controller('calendarCtrl', ['$scope', '$filter', '$http', '$q', '$timeout', '$log', function ($scope, $filter, $http, $q, $timeout, $log) {
//                $scope.dayFormat = "d";
//
